...
Tests for the Relate Auxilliary Core Module
...
from ..rel import (NOCOV, MATCH, DELET, INS_5, INS_3, INS_8,
                   MINS5, MINS3, ANY_8, SUB_A, SUB_C, SUB_G,
                   SUB_T, ANY_B, ANY_D, ANY_H, ANY_V, ANY_N,
