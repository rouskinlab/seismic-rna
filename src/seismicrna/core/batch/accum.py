...
def accumulate_counts(
    ...
    *,
    ...
    for num_reads_i, end_counts_i, count_per_pos_i, count_per_read_i in batch_counts:
...
def accumulate_confusion_matrices(
    ...
    """
    logger.routine(f"Began accumulating confusion matrices of {num_batches} batches")
    ...
    for n_batch, a_batch, b_batch, ab_batch in dispatch(
        ...
        b += b_batch
        ab += ab_batch
    logger.routine(f"Ended accumulating confusion matrices of {num_batches} batches")
    return n, a, b, ab
