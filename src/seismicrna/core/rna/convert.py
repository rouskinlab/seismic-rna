...
@run_func(CMD_CT2DB)
def run_ct_to_db(input_path: Iterable[str | Path], *, force: bool, num_cpus: int):
...
@run_func(CMD_DB2CT)
def run_db_to_ct(input_path: Iterable[str | Path], *, force: bool, num_cpus: int):
...
params = [arg_input_path, opt_force, opt_num_cpus]
