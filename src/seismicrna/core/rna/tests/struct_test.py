...
class TestRNAStructure(ut.TestCase):
    def test_init_success(self):
        ...
        self.assertTrue(
            structure.table.equals(pd.Series([5, 4, 0, 2, 1], region.range))
        )
    ...
    def test_from_db_string(self):
        ...
        self.assertEqual(
            struct.region, Region("myref", "ACGATACAG", seq5=11, name="myreg")
        )
    ...
    def test_is_paired(self):
        ...
        expected = pd.Series(
            [True, True, True, True, True, True, True, True, True, True], region.range
        )
        self.assertTrue(structure.is_paired.equals(expected))
    ...
    def test_is_paired_internally(self):
        ...
        region = Region("myref", "ACCGTACCGT")
        structure = RNAStructure(
            title="mystructure", region=region, pairs=[(2, 9), (3, 8), (4, 7), (5, 6)]
        )
        expected = pd.Series(
        ...
        structure = RNAStructure(
            title="mystructure", region=region, pairs=[(1, 10), (2, 9), (3, 8), (4, 7)]
        )
        expected = pd.Series(
        ...
        # (2,8)-(3,7)-(4,6)
        structure = RNAStructure(
            title="mystructure", region=region, pairs=[(2, 8), (3, 7), (4, 6)]
        )
        expected = pd.Series(
        ...
        structure = RNAStructure(
            title="mystructure", region=region, pairs=[(2, 8), (3, 7)]
        )
        expected = pd.Series(
            [False, False, False, False, False, False, False, False, False, False],
            region.range,
...
class TestCalcWfmi(ut.TestCase):
    ...
    def test_internal_pairs_only(self):
        region = Region("myref", "ACCGTACCGT")
        struct1 = RNAStructure(
            title="struct1", region=region, pairs=[(2, 9), (3, 8), (4, 7), (5, 6)]
        )
        struct2 = RNAStructure(
            title="struct2", region=region, pairs=[(2, 9), (3, 8), (4, 7), (5, 6)]
        )
    ...
    def test_different_regions(self):
        ...
        struct1 = RNAStructure(title="struct1", region=region1, pairs=[(1, 5), (2, 4)])
        struct2 = RNAStructure(title="struct2", region=region2, pairs=[(1, 5), (2, 4)])
    ...
    def test_mixed_paired_unpaired(self):
        region = Region("myref", "ACCGTACCGT")
        struct1 = RNAStructure(
            title="struct1", region=region, pairs=[(1, 10), (2, 9), (3, 8)]
        )
        struct2 = RNAStructure(
            title="struct2", region=region, pairs=[(1, 10), (2, 9), (4, 7)]
        )
        wfmi = calc_wfmi(struct1, struct2)
    ...
    def test_mixed_paired_unpaired_subset(self):
        ...
        struct2 = RNAStructure(title="struct2", region=region, pairs=[(1, 10), (2, 9)])
        wfmi = calc_wfmi(struct1, struct2)
    ...
    def test_all_vs_internal_pairs_1(self):
        region = Region("myref", "ACCGTACCGT")
        struct1 = RNAStructure(
            title="struct1", region=region, pairs=[(3, 8), (4, 7), (5, 6)]
        )
        struct2 = RNAStructure(
            title="struct2", region=region, pairs=[(2, 9), (3, 8), (4, 7)]
        )
    ...
    def test_all_vs_internal_pairs_2(self):
        ...
        struct2 = RNAStructure(
            title="struct2", region=region, pairs=[(1, 10), (2, 9), (3, 8), (4, 7)]
        )
        wfmi = calc_wfmi(struct1, struct2, terminal_pairs=True)
