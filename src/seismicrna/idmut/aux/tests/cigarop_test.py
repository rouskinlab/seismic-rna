...
from seismicrna.idmut.py.cigar import (
    CIG_ALIGN,
    CIG_MATCH,
    CIG_SUBST,
    CIG_DELET,
...
from seismicrna.idmut.aux.cigarop import (
    CigarOp,
    count_cigar_muts,
        ...
        for op in string.printable:
            if op not in self.ops:
                self.assertRaisesRegex(
                    ValueError, "Invalid CIGAR operation: ", CigarOp, op
                )
...
class TestFindCigarOpPosRead(ut.TestCase):
    ...
    def test_cigar_xeq_aln_valid(self):
        ...
        self.assertEqual(
            list(find_cigar_op_pos_read("9S23=1X3I13=1D9=2I31=1I25=", CIG_ALIGN)), []
        )
    ...
    def test_cigar_m_ins_valid(self):
        ...
        self.assertEqual(
            list(find_cigar_op_pos_read("9S24M3I13M1D9M2I31M1I25M", CIG_INSRT)),
            [34, 35, 36, 59, 60, 92],
        )
    ...
    def test_cigar_xeq_scl_valid(self):
        ...
        self.assertEqual(
            list(find_cigar_op_pos_read("9S23=1X3I13=1D9=2I31=1I25=", CIG_SCLIP)),
            [1, 2, 3, 4, 5, 6, 7, 8, 9],
        )
    ...
    def test_cigar_m_scl_valid(self):
        ...
        self.assertEqual(
            list(find_cigar_op_pos_read("9S24M3I13M1D9M2I31M1I25M", CIG_SCLIP)),
            [1, 2, 3, 4, 5, 6, 7, 8, 9],
        )
