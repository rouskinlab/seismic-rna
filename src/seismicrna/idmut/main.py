...
from ..core.arg import (CMD_IDMUT,
                        arg_input_path,
                        arg_fasta,
                        opt_out_dir,
                        opt_tmp_pfx,
...
@run_func(CMD_IDMUT, with_tmp=True, pass_keep_tmp=True)
def run(fasta: str | Path,
    ...
    if sep_strands:
        ...
        idmut_fasta = fasta_dir.joinpath(fasta.name)
        write_both_strands(fasta, idmut_fasta, rev_label)
    else:
        idmut_fasta = fasta
