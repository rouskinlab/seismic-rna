...
class FilterPositionTable(FilterTable, PartialPositionTable, ABC):
    pass


class FilterReadTable(FilterTable, PartialReadTable, ABC):
    pass


class FilterPositionTableWriter(PositionTableWriter, FilterPositionTable):
    pass


class FilterReadTableWriter(ReadTableWriter, FilterReadTable):
    pass


class FilterPositionTableLoader(PositionTableLoader, FilterPositionTable):
    pass


class FilterReadTableLoader(ReadTableLoader, FilterReadTable):
    pass
...
class PartialTabulator(Tabulator, ABC):
    ...
    def correct_bias(self):
        ...
        correct_bias = self.min_mut_gap > 0
        logger.trace(
            (
                "{} needs bias correction because min_mut_gap={}"
                if correct_bias
                else "{} does not need bias correction because min_mut_gap={}"
            ),
            self,
            self.min_mut_gap,
        )
    ...
    def _adjusted(self):
        ...
        if self.correct_bias:
            ...
            with logger.trace.single_context("Adjusting counts for {}", self):
                try:
...
class FilterBatchTabulator(BatchTabulator, FilterTabulator):
    pass


class FilterCountTabulator(CountTabulator, FilterTabulator):
    pass


class FilterDatasetTabulator(PartialDatasetTabulator, FilterTabulator):
    pass
