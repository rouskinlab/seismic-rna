...
Each batch of relation vectors is a ``IDmutBatchIO`` object.
...
IDmut batch: Structure of read numbers
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
IDmut batch: Structure of 5' and 3' end positions
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

- ``end5s``, ``mid5s``, ``mid3s``, and ``end3s`` are all 1-dimensional
  ``numpy.ndarray`` objects.
- For any IDmut batch, ``end5s``, ``mid5s``, ``mid3s``, and ``end3s``
...
IDmut batch: Structure of mutations
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
In an IDmut batch, they would be encoded as follows:
