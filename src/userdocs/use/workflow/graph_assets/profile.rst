...
You can give any number of per-position table files:

- ``idmut-position-table.csv``
- ``filter-position-table.csv``
- ``cluster-position-table.csv``
...
Outputs:
    ...
    - ``out/{sample}/graph/{ref}/{reg}/profile_filtered_m-ratio-q0.csv`` ::
    ...
    - ``out/{sample}/graph/{ref}/{reg}/profile_filtered_m-ratio-q0.html``
...
Outputs:
    ...
    - ``out/{sample}/graph/{ref}/{reg}/profile_filtered_acgtdi-ratio-q0.csv`` ::
    ...
    - ``out/{sample}/graph/{ref}/{reg}/profile_filtered_acgtdi-ratio-q0.html``
...
Outputs:
    ...
    - ``out/{sample}/graph/{ref}/{reg}/profile_filtered_n-count.csv`` ::
    ...
    - ``out/{sample}/graph/{ref}/{reg}/profile_filtered_n-count.html``
